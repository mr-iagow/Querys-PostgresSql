SELECT 
		...
		frtt.credit_card_receipt_date AS recebimento_gateway,
...
FROM 
		financial_receivable_titles AS frt 
JOIN 
		financial_receipt_titles AS frtt ON frtt.financial_receivable_title_id = frt.id

WHERE 
		DATE (frtt.credit_card_receipt_date) BETWEEN '2024-04-01' AND '2024-04-30'
