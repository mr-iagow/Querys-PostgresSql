...
LEFT JOIN financers_natures AS fn on fn.id = cpa.financer_nature_id

WHERE cpa.payment_date BETWEEN '2024-11-01' AND '2024-11-06'
AND fn.title LIKE '%DO - Despesas Reforma%'