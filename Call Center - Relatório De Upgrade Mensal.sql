...
WHERE
	...
	AND spr.huawei_profile_name IN ('100M_STANDARD','200M_STANDARD','300M_STANDARD','400M_STANDARD','500M_STANDARD','600M_STANDARD')
	AND c.contract_type_id <>13
	--AND c.company_place_id IN (2,6,7)
	AND pat.patrimony_type_id <> 1
	AND c.contract_type_id  NOT IN (35,36,37)
