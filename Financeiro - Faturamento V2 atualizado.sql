...
WHERE date(notas.issue_date) BETWEEN '2026-05-01' AND '2026-05-31' -- Alterado de out_date para issue_date por conta do faturamento antecipado da LB Jebnet
...
AND notas.status != 3 -- Remoção de notas com status aguardando emissão
